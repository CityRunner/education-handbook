# Корень зла
#
# Не все любят математику, а кто-то даже считает её
# настоящим злом во плоти, хотя от неё никуда не деться.
# К примеру, Python изначально разрабатывался только для
# решения математических задач, поэтому давайте используем его,
...
# Если корней конечное число — их нужно вывести через пробел
# в порядке возрастания с точностью до сотых.
