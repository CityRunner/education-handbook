...
#
# Формат вывода
# Два числа — количество вариантов, в которых Вася попадает на семинар
# и количество всех вариантов групп на семинаре.
#
# Примечание
# В первом примере обозначим участников числами 1, 2, 3, 4. Предположим,
# что 1 — это Вася.
#
